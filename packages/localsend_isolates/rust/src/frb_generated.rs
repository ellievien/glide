...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1046991617;
...
fn wire__crate__api__discovery__RsDiscovery_set_announcing_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "RsDiscovery_set_announcing",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_that = <RustOpaqueMoi<
                flutter_rust_bridge::for_generated::RustAutoOpaqueInner<RsDiscovery>,
            >>::sse_decode(&mut deserializer);
            let api_announcing = <bool>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let mut api_that_guard = None;
                    ...
                    let api_that_guard = api_that_guard.unwrap();
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::discovery::RsDiscovery::set_announcing(
                            &*api_that_guard,
                            api_announcing,
                        );
                    })?;
...
fn wire__crate__api__http__RsHttpClient_upload_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            let api_resume_offset = <u64>::sse_decode(&mut deserializer);
...
fn wire__crate__api__server__RsHttpServer_set_discoverable_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "RsHttpServer_set_discoverable",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    ...
                    let api_that_guard = api_that_guard.unwrap();
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::server::RsHttpServer::set_discoverable(
                            &*api_that_guard,
                            api_discoverable,
                        );
                    })?;
...
const _: fn() = || {
    ...
    }
    {
        ...
        let _: std::collections::HashMap<String, u64> = PrepareUploadResponseDto.resume_offsets;
    }
    {
...
impl SseDecode for crate::api::http::RsHttpClientError {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        match tag_ {
            ...
            5 => {
                return crate::api::http::RsHttpClientError::Cancelled;
            }
            _ => {
                unimplemented!("");
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        14 => wire__crate__api__discovery__RsDiscovery_set_announcing_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        29 => wire__crate__api__server__RsHttpServer_set_discoverable_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
impl flutter_rust_bridge::IntoDart for FrbWrapper<crate::api::model::PrepareUploadResponseDto> {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.0.files.into_into_dart().into_dart(),
            self.0.resume_offsets.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::http::RsHttpClientError {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            ...
            crate::api::http::RsHttpClientError::Cancelled => [5.into_dart()].into_dart(),
            _ => {
                unimplemented!("");
            }
        }
...
impl flutter_rust_bridge::IntoDart for crate::api::http::RsUploadEvent {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            crate::api::http::RsUploadEvent::Progress {
                progress,
                sent_bytes,
            } => [
                0.into_dart(),
                progress.into_into_dart().into_dart(),
                sent_bytes.into_into_dart().into_dart(),
            ]
            .into_dart(),
...
impl SseEncode for crate::api::model::PrepareUploadResponseDto {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <std::collections::HashMap<String, u64>>::sse_encode(self.resume_offsets, serializer);
    }
}
...
impl SseEncode for crate::api::http::RsHttpClientError {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            ...
            crate::api::http::RsHttpClientError::Cancelled => {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {
            crate::api::http::RsUploadEvent::Progress {
                ...
                <u64>::sse_encode(sent_bytes, serializer);
            }
            crate::api::http::RsUploadEvent::Failed { error } => {
                <i32>::sse_encode(1, serializer);
