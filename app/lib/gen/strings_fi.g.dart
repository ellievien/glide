...
class _Translations$networkInterfacesPage$fi extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Oletuksena GLIDE käyttää kaikkia saatavilla olevia verkkoliitäntöjä. Voit sulkea pois verkkoliitännät, joita et halua. Sinun tulee uudelleenkäynnistää GLIDE ottaaksesi muutokset käyttöön.';
  @override
...
class _Translations$receiveOptionsPage$fi extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(GLIDE-kansio)';
  @override
...
class _Translations$webSharePage$fi extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'GLIDE käyttää itse allekirjoitettua sertifikaattia. Sinun on hyväksyttävä se selaimessasi.';
  @override
...
class _Translations$aboutPage$fi extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Tietoja GLIDEista';
  @override
  List<String> get description => [
    'GLIDE on ilmainen, avoimen lähdekoodin sovellus, jonka avulla voit turvallisesti jakaa tiedostoja ja lähettää viestejä läheisten laitteiden kanssa paikallisessa verkossasi ilman internet-yhteyttä.',
    'GLIDE on saatavilla Androidille, iOS:lle, Linuxille, macOS:lle ja Windowsille. Kaikki latausvaihtoehdot löytyvät virallisilta kotisivuilta.',
  ];
  @override
...
class _Translations$donationPage$fi extends Translations$donationPage$en {
  ...
  @override
  String get info => 'GLIDE on ilmainen, avoimen lähdekoodin sovellus ilman mainoksia. Voit tukea projektia lahjoituksella, jos pidät sovelluksesta.';
  @override
...
class _Translations$settingsTab$general$fi extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Näytä GLIDE kontekstivalikossa';
  @override
...
class _Translations$settingsTab$network$fi extends Translations$settingsTab$network$en {
  ...
  @override
  String get needRestart => 'Käynnistä GLIDE uudelleen saadaksesi muutokset käyttöön!';
  @override
...
class _Translations$settingsTab$other$fi extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Tue GLIDEia';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$fi extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'GLIDE ei löydä muita laitteita ilman lupaa skannata paikallisverkkoa. Anna tämä lupa asetuksissa.';
  @override
...
class _Translations$dialogs$sendModeHelp$fi extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Vastaanottajat, joilla ei ole GLIDEia asennettuna, voivat ladata valitut tiedostot avaamalla linkin selaimessaan.';
}
